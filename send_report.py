...
def sendmail(file_new):
	...
	#smtp.login('85202811@qq.com','qq85202811QQ') #//QQmail授权码
	smtp.login('85202811@qq.com','koxpppvrjeeycbcc')
...
def sendreport():
	...
	lists2 = []
	a = ''
	result_report = 'C:\\Users\\lyancoffee\\Desktop\\py\\testcase\\report'
	lists = os.listdir('C:\\Users\\lyancoffee\\Desktop\\py\\testcase\\report')
	for i in lists:
